...
const themeKeys = new Set(["radius", "font-sans", "font-mono", "font-pixel"]);
const theme = {};
const light = {};
...
// As famílias Adila (Std/Code/Pixel) são servidas via @font-face self-hosted.
// O app importa src/styles/fonts.css (bundled); consumidores do registry recebem
...
const baseItem = {
  ...
  description:
    "Tokens do design system adila.co (indigo adila.co, neutros ChatGPT, Adila Std / Adila Code / Adila Pixel) em light e dark.",
  dependencies: ["tw-animate-css"],
  registryDependencies: ["utils"],
  // @import injetado no CSS global do consumidor (shadcn trata `@import`
  // nativamente) — carrega os @font-face das famílias Adila a partir do R2.
