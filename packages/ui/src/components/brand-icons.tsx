...
/** Marca oficial do Google em quatro cores. */
function GoogleBrandIcon(props: ComponentProps<"svg">) {
  return (
...
/** Marca do GitHub em uma cor, herdada por `currentColor`. */
function GitHubBrandIcon(props: ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export { GitHubBrandIcon, GoogleBrandIcon };
