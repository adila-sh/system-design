// Traduções pt-br para a UI do Fumadocs (busca, tema, sumário, paginação, 404…).
// As chaves são o texto original em inglês — precisam bater exatamente com as
// definidas em `fumadocs-ui` (Translations). Passadas via RootProvider `i18n`.
export const ptBR: Partial<Record<string, string>> = {
